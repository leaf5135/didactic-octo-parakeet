...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference("Permission.count") do
      post permissions_url, params: { permission: { action: @permission.action, description: @permission.description, resource: @permission.resource } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { action: @permission.action, description: @permission.description, resource: @permission.resource } }
